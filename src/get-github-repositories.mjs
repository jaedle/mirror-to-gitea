			...
			if (!allOrgs || allOrgs.length === 0) {
				...
				if (includeOrgs.length === 0) {
					...
					if (allOrgs && allOrgs.length > 0) {
						...
						// No organizations found and none specified in includeOrgs
						console.log("No organizations found and none specified in INCLUDE_ORGS. Skipping organization repositories.");
						return [];
					}
				}
